...
namespace TerraSansanoMOD.Items.Weapons.Projectiles
{
	public class Cannonball : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Cannonball");     //The English name of the projectile
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 50; i++)
			{
				...
				Dust d = Dust.NewDustPerfect(projectile.Center + speed * 32, DustID.Vortex, speed * 2, Scale: 1.5f);
				d.noGravity = true;
			}
		}
	}
